(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  var OmegaNotationShort = function (_super) {
    __extends(OmegaNotationShort, _super);

    function OmegaNotationShort() {
      return _super !== null && _super.apply(this, arguments) || this;
    }

    Object.defineProperty(OmegaNotationShort.prototype, "name", {
      get: function get() {
        return "Omega (Short)";
      },
      enumerable: true,
    ...
    OmegaNotationShort.prototype.formatDecimal = function (value) {
      value = new Decimal(value);
      var step = Decimal.floor(value.div(1000));
      var omegaAmount = Decimal.floor(step.div(this.greek.length));
      var lastLetter = this.greek[step.toNumber() % this.greek.length] + this.createSubNum(value.toNumber() % 1000);
  ...
  exports.OmegaNotationShort = OmegaNotationShort;
